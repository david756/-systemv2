        ...
        <script type="text/javascript">
          function imprSelec()
          {
            ...
            var interval= setInterval(function(){
              if ($('.totalPedido').html()!="" && $('.pedidoCompleto').html()!="" && i==0) {
               muestra="informe";
                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-7">
                            ...
                            <table class="table table-striped">
                              ...
                              <tbody class="pedidoCompleto"></tbody>
                            </table>
                          ...
                          <div class="modal-dialog modal-sm">
                            <div class="modal-content" align="center">
                              ...
                              <form>
                                ...
                                <Title> Total: <strong></strong></Title><br>
                        ...
                        <section id="factura" class="content invoice">
                          ...
                          <div class="row invoice-info">
                            ...
                            <div class="col-sm-12 invoice-col">
                              ...
                              <br>
                              <b>Mesero:</b> <span class="mesero"></span>
                              <br><hr>
                            </div>
                            <!-- /.col -->
                          </div>
                        ...
                        <section id="informe" class="content invoice">
                          ...
                          <div class="col-sm-12 invoice-col" align="center">
                            <hr>
                            <strong>Sistema de pago restaurante Holly</strong>
                          </div>
                        </section>
                        <!-- /informe -->
