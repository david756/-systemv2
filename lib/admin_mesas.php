                    ...
                    $.ajax({
                            ...
                            success:  function (response,estado,objeto) {
                                   if (response=="exito") {
                                    ...
                                    $('#resultado').html("la mesa se agrego con exito!");
            ...
            <div class="menu_section">
              ...
              <li ><a href="admin_inicio.php"><i class="fa fa-home"></i> Inicio </a></li>
               <li><a><i class="fa fa-users"></i> Usuarios <span class="fa fa-chevron-down"></span></a>
                ...
                <li class="active"><a><i class="fa fa-th-large"></i> Mesas <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li class="current-page"><a href="admin_mesas.php">Administrar</a></li>               
                  </ul>
                </li>
