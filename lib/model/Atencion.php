...
class Atencion {
     ...
     * @param type $estado
     */
    function Atencion($idAtencion= "def",$descripcionEstado= "def",$descuento= "def",
        $cajero= "def",$mesa= "def",$horaPago= "def",$estado= "def") {
    ...
    function createAtencion() {
        try {
            ...
            $atencion=new Atencion($this->idAtencion,$this->descripcionEstado,
