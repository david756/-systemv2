    ...
    s.prototype = {
        ...
        renderCalendar: function(t, e, a, s, n) {
            ...
            if (this.timePicker) {
                ...
                var y = 0,
                    k = 59;
                for (a && ("left" == n || this.singleDatePicker) && e.format("DD-MM-YYYY h A") == a.format("DD-MM-YYYY h A") && (y = a.minute(), e.minute() < y && e.minute(y)), s && ("right" == n || this.singleDatePicker) && e.format("DD-MM-YYYY h A") == s.format("DD-MM-YYYY h A") && (k = s.minute(), e.minute() > k && e.minute(k)), f = 0; 60 > f; f += this.timePickerIncrement) {
                    var b = f;
