...
<h3 class="title1">Resgistrar Nuevo Producto</h3>
<div class="sign-up-row widget-shadow">

					<h4 class="title1">Información Del Producto</h5>
				...
				<form data-toggle="validator" action ="../includes/crud/agregar.php" method="POST">
												<div class="sign-u">
													...
													<div class="form-group">
															...
															<input type="text" maxlength="20" name="nombre" class="form-control" id="inputName" placeholder="Gaseosa ... " required>
												...
												<div class="sign-u">
													...
													<div class="form-group">
															...
															<input type="number" step="1" min="0" name="valor" class="form-control" id="inputName" placeholder=" ejemplo : 15000" required>
						...
						echo'
							<tbody>
								<tr>
								  ...
								  <td>'.$rows[3].'</td>
								  <td>'.$rows[2].'</td>
								  <td>  <h4> <a href="editar.php?editar=productos&id='.$rows[0].'&nombre='.$rows[1].'&valor='.$rows[2].'&descripcion='.$rows[3].'" class="btn btn-primary btn-xs" <span class="btn btn-primary btn-xs">Editar</span></a></h4> </td> 
