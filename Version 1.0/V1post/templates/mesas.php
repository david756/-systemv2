...
<h3 class="title1">Agragar Nueva Mesa</h3>
<div class="sign-up-row widget-shadow">

					<h4 class="title1">Informacion de la Mesa</h4>
				...
				<form data-toggle="validator" action ="../includes/crud/agregar.php" method="POST">
												<div class="sign-u">
													...
													<div class="form-group">
														<input type="text" name="nombre" class="form-control" id="inputName" placeholder="Mesa x" required>
													</div>
													<div class="clearfix"> </div>
												</div>
												...
												<div class="sub_home">
														...
														<input type="text" name ="identificador" value="mesa" style="visibility:hidden" > 
						...
						echo'
							<tbody>
								<tr>
								  ...
								  <td>'.$rows[0].'</td>
								  <td>'.$rows[1].'</td>
								  <td>  <h4> <a href="editar.php?editar=mesas&id='.$rows[0].'&nombre='.$rows[1].'" <span class="btn btn-primary btn-xs">Editar</span></a></h4> </td> 
								</tr>
							</tbody>
