...
<h3 class="title1">Resgistrar Empleado</h3>
...
if (isset($_GET['error'])) {
	if ($_GET['error']==0) {
		echo '					<div class="alert alert-success" role="alert">
						<strong>Muy bien!</strong> El empleado se guardo exitosamente.
					</div>';
	}
	else if ($_GET['error']==1) {
		echo '<div class="alert alert-danger" role="alert">
						<strong>Algo fallo!</strong> Este nombre de usuario ya esta registrado.
					</div>';
	}
}
...
<div class="sign-up-row widget-shadow">
					...
					<h4 class="title1">Información Personal</h5>
				...
				<form data-toggle="validator" action ="../includes/crud/agregar.php" method="POST">
												<div class="sign-u">
													...
													<div class="form-group">
															...
															<input type="text" name="nombre" class="form-control" id="inputName" placeholder="Juan David" required>
												...
												<div class="sign-u">
													...
													<div class="form-group">
															...
															<input type="text" name="apellido" class="form-control" id="inputName" placeholder="Hernandez" required>
												...
												<div class="sign-u">
													...
													<div class="form-group">
															...
															<input type="number" name="telefono"  step="1" min="0" data-minlength="7" class="form-control" id="inputName" placeholder="3111231231" required>
												...
												<h4 class="title1">Información de ingreso</h5>
												...
												<div class="sign-u">
													...
													<div class="form-group">
															...
															<input type="text" name="usuario" class="form-control" id="inputName" placeholder="Usuario (Debe ser unico) " required>
									  ...
									  <div class="help-block with-errors"></div>
												...
												<div class="sub_home">
														...
														<input type="text" name ="admin_creador" value= <?php echo $_SESSION['usuario_administrador_login']; ?> style="visibility:hidden" > 
							...
							echo'
								<tbody>
									<tr>
									  ...
									  <td>'.$rows[3].'</td>
									  <td>'.$rows[5].'</td>
									  <td>  <h4> <a href="editar.php?editar=empleados&id='.$rows[0].'&nombre='.$rows[1].'&apellido='.$rows[2].'&telefono='.$rows[3].'" class="btn btn-primary btn-xs" <span class="btn btn-primary btn-xs">Editar</span></a></h4> </td> 
