...
<h3 class="title1">Registrar Administrador</h3>
...
if (isset($_GET['error'])) {
	if ($_GET['error']==0) {
		echo '					<div class="alert alert-success" role="alert">
						<strong>Muy bien!</strong> El administrador se guardo exitosamente.
					</div>';
	}
...
<div class="sign-up-row widget-shadow">
			...
			<div class="main-page">
				<h3 class="title1">Administradores</h3>
							...
							echo'
								<tbody>
									<tr>
									  ...
									  <td>'.$rows[3].'</td>
									  <td>'.$rows[5].'</td>
									  <td>  <h4> <a href="editar.php?editar=administradores&id='.$rows[0].'&nombre='.$rows[1].'&apellido='.$rows[2].'&telefono='.$rows[3].'" class="btn btn-primary btn-xs" <span class="btn btn-primary btn-xs">Editar</span></a></h4> </td> 
									</tr>
								</tbody>
